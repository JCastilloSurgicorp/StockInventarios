...
class StockInventario(fl.Container):
    ...
    def connectSQL(self, sqlQuery):
        ...
        driver, trust = '{SQL Server}', ''
        self.cnxn = pdb.connect(f'DRIVER={driver}; SERVER=SVRSURGI\\SVRBIOPRO; DATABASE=SURGICORP_POWERAPPS; UID=powerapps;PWD=*Surgi007; Trusted_connection=no{trust}')
