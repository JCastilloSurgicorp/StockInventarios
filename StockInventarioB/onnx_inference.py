...
def generate_suggestion(user_prompt, max_length=50):
    ...
    messages = [
        {
            "role": "system",
            "content": "Eres un asistente de almacen que ayuda a los usuarios a saber si se tiene o no stock de ciertos productos y cuantos hay en el almacen. El usuario te entregará el nombre comercial del producto y tienes que entregarle la cantidad de producto que existe por cada producto que en su descripcion contenga el nombre brindado. Si no entendiste la pregunta o no lograste determinar cual era el producto a consultar, pide al usuario que ingrese el nombre del producto o que reformule su pregunta",
        },
        {
            "role": "user",
